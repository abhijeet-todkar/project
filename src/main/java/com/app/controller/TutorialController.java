...
public class TutorialController {
	...
	@PostMapping
	public ResponseEntity<?> addNewTutorial(@RequestBody TutorialDTO tut) {
		System.out.println("in add new tut "+ tut);
		return ResponseEntity.status(HttpStatus.CREATED).body(tutService.addNewTutorial(tut));
	}
